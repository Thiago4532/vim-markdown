...
nnoremap <silent> <Plug>Markdown_OpenUrlUnderCursor :call <sid>OpenUrlUnderCursor()<cr>
nnoremap <silent> <Plug>Markdown_EditUrlUnderCursor :call <sid>EditUrlUnderCursor()<cr>
